...
JNIEXPORT jstring JNICALL Java_com_futronictech_Scanner_GetVersionInfo(JNIEnv *env, jobject obj)
{
	...
	if( bRet )
	{
		...
		case FTR_DEVICE_USB_2_0_TYPE_80H:
			sprintf(szInfo, "%d:FS80H", infoDevice.byDeviceCompatibility );
			break;
		case FTR_DEVICE_USB_2_0_TYPE_80HS:
			sprintf(szInfo, "%d:FS80HS", infoDevice.byDeviceCompatibility );
			break;
		case FTR_DEVICE_USB_2_0_TYPE_88H:
			sprintf(szInfo, "%d:FS88H", infoDevice.byDeviceCompatibility );
			break;
		case FTR_DEVICE_USB_2_0_TYPE_88HR:
			sprintf(szInfo, "%d:FS88HR", infoDevice.byDeviceCompatibility );
			break;
		...
		case FTR_DEVICE_USB_2_0_TYPE_10:
			sprintf(szInfo, "%d:FS10", infoDevice.byDeviceCompatibility );
			break;
		...
		case FTR_DEVICE_USB_2_0_TYPE_64:
			sprintf(szInfo, "%d:FS64", infoDevice.byDeviceCompatibility );
			break;
		case FTR_DEVICE_USB_2_0_TYPE_25:
			sprintf(szInfo, "%d:FS25", infoDevice.byDeviceCompatibility );
			break;
		case FTR_DEVICE_USB_2_0_TYPE_26:
			sprintf(szInfo, "%d:FS26", infoDevice.byDeviceCompatibility );
			break;
		default:
...
JNIEXPORT jboolean JNICALL Java_com_futronictech_Scanner_SetLogOptions
  (JNIEnv *, jobject, jint mask, jint level)
{
    ftrSetLoggingFacilityLevel( mask, level, "/mnt/sdcard/Android/ftrLog.txt");
    return JNI_TRUE;
}
